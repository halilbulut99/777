...
public class CustomDialog extends JDialog implements ActionListener, PropertyChangeListener {
	...
	// CustomDialog приема EType аргумент за типа на диалога – филтриране или сортиране.
	private EType type;

	// Създаване на диалог и добавяме да приема тип на диалога
	public CustomDialog(String text, PersonDataGUI parent, EType type) {
		setTitle("Избор на сортиране");

		this.parentGui = parent;
		this.type = type; // Присвояване към глобална променлива
	...
	public CustomDialog(String sortText, copyStudentData copyStudentData, EType sort, SortOrder ascending) {
